...
type RelationshipDefinition struct {
	PredicateName string   // e.g., "is_child_of", "points_to"
	DisplayLabel  string   // Human-readable label
	Color         string   // Optional link color override
	LinkDistance  *float64 // D3 force distance (nil = use default)
	LinkStrength  *float64 // D3 force strength (nil = use default)
	Deprecated    bool     // Whether this relationship type is deprecated
}
