...
type As struct {
	...
	Contexts   []string               `db:"contexts" json:"contexts" validate:"required,min=1"`     // Object of the claim ("of X") — a grammatical slot, not a scope
	...
	SignerDID  string                 `db:"signer_did" json:"signer_did,omitempty"`                 // did:key of the signing node (ADR-026: becomes the namespace)
}
