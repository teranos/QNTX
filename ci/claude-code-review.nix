# The Claude Code Review workflow. .github/workflows/claude-code-review.yml is
# emitted from this and is never edited by hand:
#
#   nix eval --json --file ci/claude-code-review.nix | jq . > .github/workflows/claude-code-review.yml
#
    ...
    steps = [
      {
        ...
        "with".fetch-depth = 0; # Need full history to analyze PR
      }
