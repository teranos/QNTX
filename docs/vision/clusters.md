...
Individual clusters can appear as their own [element](https://github.com/teranos/elements/blob/main/VISION.md), [melded](https://github.com/teranos/elements/blob/main/VISION.md#melding) with the semantic search element. When you select a cluster in ⊨, the cluster element shows that cluster's shape and where the semantic matches land within it — so you can see how reliable a match actually is.
