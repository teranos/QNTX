...
Instead of the traditional node-and-wire paradigm of visual programming languages (VPLs), QNTX introduces **glyph melding** - a direct manipulation interface where [glyphs](https://github.com/teranos/QNTX/blob/main/packages/glyphs/VISION.md) physically fuse together through spatial proximity.
