...
| `✿` | PulseOpen | Graceful startup with orphaned job recovery. See [Opening & Closing](adr/ADR-036-GRACE.md) |
| `❀` | PulseClose | Graceful shutdown with checkpoint preservation. See [Opening & Closing](adr/ADR-036-GRACE.md) |
