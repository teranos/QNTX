...
QNTX uses `github.com/teranos/QNTX/internal/errors`, which wraps [cockroachdb/errors](https://github.com/cockroachdb/errors) for production-grade error handling.
