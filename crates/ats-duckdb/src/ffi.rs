...
pub extern "C" fn duckdb_storage_put(
    ...
    qntx_ffi_common::guarded_result("duckdb_storage_put", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_storage_get(
    ...
    qntx_ffi_common::guarded_result("duckdb_storage_get", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_storage_exists(
    ...
    qntx_ffi_common::guarded_result("duckdb_storage_exists", || {
        if store.is_null() {
            return StorageResultC::error("null store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_storage_delete(
    ...
    qntx_ffi_common::guarded_result("duckdb_storage_delete", || {
        if store.is_null() {
            return StorageResultC::error("null store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_storage_count(store: *const DuckdbStore) -> CountResultC {
    qntx_ffi_common::guarded_result("duckdb_storage_count", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_storage_clear(store: *mut DuckdbStore) -> StorageResultC {
    qntx_ffi_common::guarded_result("duckdb_storage_clear", || {
        if store.is_null() {
            return StorageResultC::error("null store pointer");
        }
        let store = unsafe { &mut *store };
...
pub extern "C" fn duckdb_storage_query(
    ...
    qntx_ffi_common::guarded_result("duckdb_storage_query", || {
        if store.is_null() {
            return AttestationResultC::error("null store pointer");
        }
...
pub extern "C" fn duckdb_storage_get_many(
    ...
    qntx_ffi_common::guarded_result("duckdb_storage_get_many", || {
        if store.is_null() {
            return AttestationResultC::error("null store pointer");
        }
...
pub extern "C" fn duckdb_namespaces_list(store: *const NamespaceStore) -> NamespacesResultC {
    qntx_ffi_common::guarded_result("duckdb_namespaces_list", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_users_put(
    ...
    qntx_ffi_common::guarded_result("duckdb_users_put", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_users_by_route(
    ...
    qntx_ffi_common::guarded_result("duckdb_users_by_route", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_users_list(store: *const UserStore) -> UsersResultC {
    qntx_ffi_common::guarded_result("duckdb_users_list", || {
        if store.is_null() {
            return UsersResultC::error("null user store pointer");
        }
        let store = unsafe { &*store };
...
pub extern "C" fn duckdb_tokens_put(
    ...
    qntx_ffi_common::guarded_result("duckdb_tokens_put", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_tokens_lookup(
    ...
    qntx_ffi_common::guarded_result("duckdb_tokens_lookup", || {
        if store.is_null() {
            return StorageResultC::error("null token store pointer");
        }
...
pub extern "C" fn duckdb_tokens_resolve(
    ...
    qntx_ffi_common::guarded_result("duckdb_tokens_resolve", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_tokens_list(store: *const TokenStore) -> TokensResultC {
    qntx_ffi_common::guarded_result("duckdb_tokens_list", || {
        if store.is_null() {
            return TokensResultC::error("null token store pointer");
        }
        let store = unsafe { &*store };
...
pub extern "C" fn duckdb_tokens_enable(
    ...
    qntx_ffi_common::guarded_result("duckdb_tokens_enable", || {
...
pub extern "C" fn duckdb_tokens_set_scope(
    ...
    qntx_ffi_common::guarded_result("duckdb_tokens_set_scope", || {
...
pub extern "C" fn duckdb_tokens_touch(
    ...
    qntx_ffi_common::guarded_result("duckdb_tokens_touch", || {
...
pub extern "C" fn duckdb_watchers_free(store: *mut WatcherStore) -> *mut c_char {
    qntx_ffi_common::guarded(
        ...
        |msg| {
            cstring_new_or_fallback(
                &msg,
                "panic reached the FFI boundary and the reason could not be encoded",
            )
        },
    )
}
...
pub extern "C" fn duckdb_watchers_put(
    ...
    qntx_ffi_common::guarded_result("duckdb_watchers_put", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_watchers_list(store: *const WatcherStore) -> WatchersResultC {
    qntx_ffi_common::guarded_result("duckdb_watchers_list", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_watchers_recent_fires(
    ...
    qntx_ffi_common::guarded_result("duckdb_watchers_recent_fires", || {
        if store.is_null() {
            return WatchersResultC::error("null watcher store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_watchers_delete(
    ...
    qntx_ffi_common::guarded_result("duckdb_watchers_delete", || {
        if store.is_null() {
            return StorageResultC::error("null watcher store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_watchers_record_fire(
    ...
    qntx_ffi_common::guarded_result("duckdb_watchers_record_fire", || {
        if store.is_null() {
            return StorageResultC::error("null watcher store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_watchers_record_error(
    ...
    qntx_ffi_common::guarded_result("duckdb_watchers_record_error", || {
        if store.is_null() {
            return StorageResultC::error("null watcher store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_watchers_flush(store: *mut WatcherStore) -> StorageResultC {
    qntx_ffi_common::guarded_result("duckdb_watchers_flush", || {
        if store.is_null() {
            return StorageResultC::error("null watcher store pointer");
        }
...
pub extern "C" fn duckdb_watchers_tally(
    ...
    qntx_ffi_common::guarded_result("duckdb_watchers_tally", || {
        if store.is_null() {
            return WatchersResultC::error("null watcher store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_schedules_put(
    ...
    qntx_ffi_common::guarded_result("duckdb_schedules_put", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_schedules_list(store: *const ScheduleStore) -> SchedulesResultC {
    qntx_ffi_common::guarded_result("duckdb_schedules_list", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_schedules_due(
    ...
    qntx_ffi_common::guarded_result("duckdb_schedules_due", || {
        if store.is_null() {
            return SchedulesResultC::error("null schedule store pointer");
        }
...
pub extern "C" fn duckdb_schedules_next(store: *const ScheduleStore) -> SchedulesResultC {
    qntx_ffi_common::guarded_result("duckdb_schedules_next", || {
        if store.is_null() {
            return SchedulesResultC::error("null schedule store pointer");
        }
        let next: Vec<ScheduleDeclaration> =
...
pub extern "C" fn duckdb_schedules_delete(
    ...
    qntx_ffi_common::guarded_result("duckdb_schedules_delete", || {
        if store.is_null() {
            return StorageResultC::error("null schedule store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_schedules_record_run(
    ...
    qntx_ffi_common::guarded_result("duckdb_schedules_record_run", || {
        if store.is_null() {
            return StorageResultC::error("null schedule store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_schedules_reschedule(
    ...
    qntx_ffi_common::guarded_result("duckdb_schedules_reschedule", || {
        if store.is_null() {
            return StorageResultC::error("null schedule store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_schedules_flush(store: *mut ScheduleStore) -> StorageResultC {
    qntx_ffi_common::guarded_result("duckdb_schedules_flush", || {
        if store.is_null() {
            return StorageResultC::error("null schedule store pointer");
        }
        match unsafe { &mut *store }.flush() {
...
pub extern "C" fn duckdb_schedules_progress(
    ...
    qntx_ffi_common::guarded_result("duckdb_schedules_progress", || {
        if store.is_null() {
            return SchedulesResultC::error("null schedule store pointer");
        }
        let id_str = match unsafe { cstr_to_str(id) } {
...
pub extern "C" fn duckdb_attestation_result_free(result: AttestationResultC) {
    qntx_ffi_common::guarded(
        "duckdb_attestation_result_free",
        || unsafe {
            free_cstring(result.error_msg);
...
pub extern "C" fn duckdb_identity_load(store: *const IdentityStore) -> TokensResultC {
    qntx_ffi_common::guarded_result("duckdb_identity_load", || {
        if store.is_null() {
...
pub extern "C" fn duckdb_identity_save(
    ...
    qntx_ffi_common::guarded_result("duckdb_identity_save", || {
        if store.is_null() {
