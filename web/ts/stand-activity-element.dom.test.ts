...
describe('Stand Activity panel', () => {
    ...
    test('the element id names the stand, so two stands are two panels', () => {
        expect(standElementId('clean', 'boutique')).toBe('stand-activity-clean-boutique');
        expect(standElementId('clean', 'home')).not.toBe(standElementId('clean', 'boutique'));
        expect(standElementId('other', 'boutique')).not.toBe(standElementId('clean', 'boutique'));
    });
    ...
    test('a page opens its element, and the panel navigates nowhere', () => {
    ...
    test('a page element is one page of one stand', () => {
        expect(pageElementId('clean', 'boutique', '/en.html')).toBe('stand-page-clean-boutique-/en.html');
        expect(pageElementId('clean', 'boutique', '/a')).not.toBe(pageElementId('clean', 'boutique', '/b'));
    });

    test('a page element accounts for that page alone', () => {
