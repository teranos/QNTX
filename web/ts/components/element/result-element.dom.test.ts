/**
 * Tests for result element component
...
describe('ResultElement', () => {
    ...
    describe('rendering', () => {
        test('creates element with result and base element classes', () => {
        ...
        test('has header with copy button', () => {
            const element = createResultElement(item, result);
            const header = element.querySelector('.result-element-header');
    ...
    describe('output rendering', () => {
        test('displays stdout text', () => {
            const element = createResultElement(item, result);
            const outputContainer = element.querySelector('.result-element-output');
