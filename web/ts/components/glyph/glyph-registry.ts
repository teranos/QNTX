...
import { AX, IX, SO, Prose, Subcircuit } from '@generated/sym.js';
...
const GLYPH_TYPES: GlyphTypeEntry[] = [
    ...
    { symbol: Subcircuit, className: 'canvas-subcircuit-glyph', title: 'Subcircuit', label: 'Subcircuit', render: createSubcircuitGlyph },
];
