...
import { AX, IX, SO, Prose, Canvas } from '@generated/sym.js';
...
const GLYPH_TYPES: GlyphTypeEntry[] = [
    ...
    { symbol: Canvas,   className: 'canvas-nested-glyph',  title: 'Canvas',   label: 'Canvas', render: createNestedCanvasGlyph },
];
