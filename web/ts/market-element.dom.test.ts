 ...
 *
 * Stands element — a list row, a stand opened, and the create form (ADR-035).
 */

import { describe, test, expect, beforeEach } from 'bun:test';
import { renderStandList, renderStandDetail, buildCreateForm, standSnippet, type StaandInfo } from './market-element.ts';
