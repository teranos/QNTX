...
import { initializeDots } from './dot-registry.ts';
...
async function init(): Promise<void> {
    ...
    // Initialize dots (dot-as-primitive system)
    // Registers dots on startup - they expand into windows rather than vice versa
    initializeDots();

    // Restore expanded windows from previous session
