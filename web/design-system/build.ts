...
const titleBarSource = resolve(import.meta.dir, '../css/element/title-bar.css')
...
const canvasPlacedSource = resolve(import.meta.dir, '../css/element/states/canvas-placed.css')
await copyFile(canvasPlacedSource, join(outDir, 'canvas-placed.css'))
const dotSource = resolve(import.meta.dir, '../css/element/states/dot.css')
await copyFile(dotSource, join(outDir, 'dot.css'))
const morphSource = resolve(import.meta.dir, '../css/element/transitions/morph.css')
