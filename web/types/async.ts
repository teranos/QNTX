/**
 * Pulse async job types. Mirrors the Go package `pulse/async`, which declares
 * them; the browser reads them here.
 *
 * Job carries ISO 8601 date strings ("2024-01-15T10:30:00Z") — frontend code
 * parses them with new Date(job.created_at).
 */
