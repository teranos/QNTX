        ...
        ciImage = pkgs.dockerTools.buildLayeredImage {
          ...
          config = {
            Env = [
              ...
              "PKG_CONFIG_PATH=${pkgs.lib.concatMapStringsSep ":" (p: "${p}/lib/pkgconfig") [ pkgs.glib.dev pkgs.gtk3.dev pkgs.webkitgtk_4_1.dev pkgs.libayatana-appindicator pkgs.librsvg ]}"
