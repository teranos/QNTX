...
let
  ...
  provenanceFooter = ''
        <footer class="site-footer">
            <p class="provenance">Generated by ${provenance.generator} at commit <a href="https://github.com/${githubRepo}/commit/${provenance.fullCommit}">${provenance.commit}</a></p>
        </footer>
  '';
...
${provenanceFooter}
  ...
  buildInfoContent = builtins.toJSON {
