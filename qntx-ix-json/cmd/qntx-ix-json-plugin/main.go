...
// via gRPC. It polls JSON APIs and transforms responses into attestations.
//
// Usage:
//
...
func main() {
	...
	if *version {
		plugin := qntxixjson.NewPlugin()
		meta := plugin.Metadata()
		fmt.Printf("qntx-ix-json-plugin %s\n", meta.Version)
	...
	logger.Infow("Starting QNTX ix-json Plugin",
