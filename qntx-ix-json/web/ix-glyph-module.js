...
async function saveConfig(ui, glyphId, apiUrlEl, authTokenEl, pollIntervalEl, status) {
  try {
...
async function testFetch(ui, glyphId, apiUrlEl, authTokenEl, preview, status) {
...
async function setMode(ui, glyphId, mode, apiUrlEl, authTokenEl, pollIntervalEl, status) {
  try {
