...
func TestMatchOrigin(t *testing.T) {
	tests := []struct {
		...
		{"with port", "http://localhost:8770", "http://localhost", true},
		{"with high port", "http://localhost:8820", "http://localhost", true},
		{"evil subdomain", "http://localhost.evil.com", "http://localhost", false},
		{"evil subdomain with port", "http://localhost.evil.com:8770", "http://localhost", false},
		{"ip exact", "http://127.0.0.1", "http://127.0.0.1", true},
		{"ip with port", "http://127.0.0.1:8770", "http://127.0.0.1", true},
