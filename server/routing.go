...
func (s *QNTXServer) setupHTTPRoutes() {
	...
	http.HandleFunc("/api/search/meilisearch/reindex", wrap(s.HandleMeiliReindex))                 // Meilisearch reindex (POST)
	http.HandleFunc("/api/search/meilisearch/stats", wrap(s.HandleMeiliStats))                     // Meilisearch stats (GET)
	http.HandleFunc("/api/search/meilisearch", wrap(s.HandleMeiliSearch))                          // Meilisearch full-text search (GET)
